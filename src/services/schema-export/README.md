...
Models: linkingObjects and default values are NOT stored in Realm files.
...
Swift types of an array: can they not be optional? (see https://realm.io/docs/swift/latest/#property-cheatsheet)

Java MutableRealmInteger https://realm.io/docs/java/latest/#counters are implemented as Long in schema, so we can't extrapolate this type from the schema.
